...
function keyPressed() {
if (keyDown(UP_ARROW)) {
Matter.Body.applyForce(bob1.position.x,bob1.position.y);
...
//WRITE A CORRECT CODE TO APPLY A KEYPRESSED TO 
//CHANGE THE POSITION OF BALL OBJECT TO THE LEFT WHEN UP ARROW KEY IS PRESSED
